...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex min-h-[20vh] sm:min-h-[50vh] lg:min-h-[40vh] flex-col items-center justify-center overflow-hidden bg-transparent w-full rounded-md z-0",
                className
            )}
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 mt-5 sm:mt-20 ">
                <motion.div
                ...
                <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-blue-400 opacity-50 blur-3xl"></div>
                <motion.div
                    initial={{ width: "8rem" }}
            ...
            <div className="relative z-50 flex -translate-y-[75px]  sm:-translate-y-[300px] md:-translate-y-[100px] lg:-translate-y-[200px] flex-col items-center px-5">
                {children}
            </div>
        </div>
    );
